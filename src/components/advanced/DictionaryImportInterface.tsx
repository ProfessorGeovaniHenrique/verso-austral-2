          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <DictionaryMetadataCard
              metadata={{
                ...
                tipo: 'pombo_abl',
                esperado: 50000,
                atual: jobs?.find(j => j.tipo_dicionario === 'pombo_abl')?.verbetes_inseridos || 0,
            ...
            <DictionaryMetadataCard
              metadata={{
                ...
                edicao: '1ª edição',
                ano: 2014,
                tipo: 'navarro_nordeste_2014',
                esperado: 15000,
                atual: jobs?.find(j => j.tipo_dicionario === 'navarro_nordeste_2014')?.verbetes_inseridos || 0,
