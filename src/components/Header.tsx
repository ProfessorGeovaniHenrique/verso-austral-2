...
const Header = () => {
  ...
  return <header className="fixed top-0 left-0 right-0 z-50 border-b-2 border-primary bg-background shadow-sm header-animated">
      <div className="px-6 py-4 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button variant="ghost" size="icon" onClick={toggleTheme} className="rounded-full" title={mode === 'academic' ? 'Alternar para Modo Cósmico' : 'Alternar para Modo Acadêmico'}>
            ...
            <DropdownMenuContent className="w-56" align="end" forceMount>
              <DropdownMenuLabel className="font-normal">
                <div className="flex flex-col space-y-1">
                  ...
                  {role && <p className="text-xs leading-none text-muted-foreground">
          ...
          </DropdownMenu> : <Button asChild className="btn-versoaustral-secondary shrink-0">
