...
export function RhetoricalFiguresTool() {
  ...
  const { cachedData: profile, saveToCache, clearCache, hasCachedData } = useToolCache<RhetoricalProfile>('rhetorical');
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex gap-2">
            <Button onClick={handleAnalyze} disabled={isAnalyzing || !loadedCorpus}>
              ...
              {isAnalyzing ? "Analisando..." : hasCachedData ? "Reanalisar" : "Analisar Figuras"}
            </Button>
            {profile && (
              <>
