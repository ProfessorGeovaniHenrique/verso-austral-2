 ...
 * 
 * Dados baseados na análise estatística completa com:
 * - Total de palavras no corpus: 212
 * - Total de palavras funcionais: 95
 * - Total de palavras temáticas: 117
 * 
 * Frequências normalizadas calculadas sobre as 117 palavras temáticas (excluindo funcionais)
 * Comparação com Corpus Nordestino para identificar super/sub-representação
 */
export const dominiosNormalizados: DominioSemantico[] = [
  ...
  },
  {
    ...
    ocorrencias: 95,
    percentual: 44.81,
    percentualTematico: 0, // Não incluído na análise temática
    palavras: [
      "de", "um", "o", "e", "em", "para", "com", "se", "bem", "mais",
      "por", "que", "daí", "ele", "entre", "já", "mas", "mesmo", 
      "onde", "ou", "seu"
    ],
    palavrasComFrequencia: [
      { palavra: "de", ocorrencias: 22 },
      { palavra: "um", ocorrencias: 15 },
      { palavra: "o", ocorrencias: 14 },
      { palavra: "e", ocorrencias: 8 },
      { palavra: "em", ocorrencias: 8 },
      { palavra: "para", ocorrencias: 5 },
      { palavra: "com", ocorrencias: 4 },
      { palavra: "se", ocorrencias: 3 },
      { palavra: "bem", ocorrencias: 2 },
      { palavra: "mais", ocorrencias: 2 }
    ],
    cor: "hsl(0, 0%, 50%)",
    corTexto: "hsl(0, 0%, 100%)",
