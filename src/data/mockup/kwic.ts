import { KWICDataMap } from "../types/corpus.types";

export const kwicDataMap: KWICDataMap = {
  "verso": [{
    leftContext: "Daí um",
    keyword: "verso",
  ...
  "olhos": [{
    leftContext: "Sonhou com os",
    keyword: "olhos",
    rightContext: "da prenda vestidos de primavera",
    source: "Luiz Marenco - Quando o verso vem pras casa"
  }, {
    leftContext: "Mas ficaram os seus",
    keyword: "olhos",
    rightContext: "negros de noite",
    source: "Luiz Marenco - Quando o verso vem pras casa"
  }],
  "tarde": [{
    ...
    leftContext: "No mesmo lugar onde o lindo fim de",
    keyword: "tarde",
